...
//4/11/2017 gebruikt voor testen met uno
//7 punt ster met 2 leds (voor en achter in het midden) totaal 9 WS2812 RGB leds
#include "FastLED.h"
...
//SimplePatternList gPatterns = { sinelon };     // use this line to display only one pattern
